...
def test_file_fileset_adapter_encode_functional_characterization_mpra_props(mock_query_props, mock_check):
...
@patch('adapters.file_fileset_adapter.check_collection_loaded', return_value=True)
@patch('adapters.file_fileset_adapter.FileFileSet.query_fileset_files_props_encode')
def test_file_fileset_adapter_encode_E2G_annotation(mock_query_props, mock_check):
    # Mock the external API calls
    mock_query_props.return_value = (
        {
            '_key': 'ENCFF324XYW',
...
@patch('adapters.file_fileset_adapter.check_collection_loaded', return_value=True)
@patch('adapters.file_fileset_adapter.FileFileSet.query_fileset_files_props_encode')
def test_file_fileset_adapter_encode_HiC_experiment_with_treatments(mock_query_props, mock_check):
    # Mock the external API calls
    mock_query_props.return_value = (
        {
            '_key': 'ENCFF610AYI',
...
@patch('adapters.file_fileset_adapter.check_collection_loaded', return_value=True)
@patch('adapters.file_fileset_adapter.FileFileSet.query_fileset_files_props_encode')
def test_file_fileset_adapter_encode_ccREs(mock_query_props, mock_check):
    # Mock the external API calls
    mock_query_props.return_value = (
        {
            '_key': 'ENCFF420VPZ',
...
def test_file_fileset_adapter_igvf_bluestarr_prediction(mock_query_props, mock_check):
    # Mock the external API calls
    mock_query_props.return_value = (
        {
            '_key': 'IGVFFI1236SEPK',
...
@patch('adapters.file_fileset_adapter.check_collection_loaded', return_value=True)
@patch('adapters.file_fileset_adapter.FileFileSet.query_fileset_files_props_igvf')
def test_file_fileset_adapter_igvf_sccripsr_screen(mock_query_props, mock_check):
    # Mock the external API calls
    mock_query_props.return_value = (
        {
            '_key': 'IGVFFI4846IRZK',
...
@patch('adapters.file_fileset_adapter.check_collection_loaded', return_value=True)
@patch('adapters.file_fileset_adapter.FileFileSet.query_fileset_files_props_igvf')
def test_file_fileset_adapter_igvf_hicar(mock_query_props, mock_check):
    # Mock the external API calls
    mock_query_props.return_value = (
        {
            '_key': 'IGVFFI6913PEWI',
