...
def test_gersbach_e2g_crispr_adapter_genomic_elements():
    ...
    assert first_item['method_type'] == 'CRISPR'
    assert first_item['type'] == 'transcription start site'
...
def test_gersbach_e2g_crispr_adapter_genomic_elements_genes():
    ...
    assert first_item['biosample_context'] == [
        'CD8-positive, alpha-beta memory T cell']
    assert first_item['biosample_term'] == ['ontology_terms/CL_0000909']
    assert first_item['biosample_qualifier'] == None
