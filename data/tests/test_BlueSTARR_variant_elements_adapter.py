...
@patch('adapters.helpers.build_spdi', return_value='NC_000005.10:1778862:T:G')
...
def test_process_file_variant(mock_file, mock_bulk_check, mock_validate, mocker):
    mocker.patch('adapters.helpers.build_variant_id',
...
def test_process_file_skips_variant_on_ref_mismatch(mock_file, mock_bulk_check, mocker):
    mocker.patch('adapters.BlueSTARR_variant_elements_adapter.load_variant',
                 return_value=(dict(), {'variant_id': 'NC_000005.10:1778862:A:G', 'reason': 'Ref allele mismatch'}))
