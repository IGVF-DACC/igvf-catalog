...
ADAPTERS = {
    ...
    'bluestarr_variant_elements': BlueSTARRVariantElement('./samples/variant_phenotype_V2F.example.tsv', label='variant_elements'),
...
LABEL_TO_ADAPTER = {
    ...
    'variant_elements': BlueSTARRVariantElement,
