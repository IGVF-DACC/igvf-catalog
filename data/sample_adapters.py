...
ADAPTERS = {
    ...
    'oncotree_terms': Oncotree(filepath='./samples/oncotree_example.json', label='node'),
    'oncotree_relationships': Oncotree(filepath='./samples/oncotree_example.json', label='edge'),
