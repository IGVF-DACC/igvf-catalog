...
def build_spdi(chr, pos, ref, alt, allele, translator):
...
def build_hgvs(chr, pos, ref, alt, allele, translator):
    # Only use translator if the ref or alt is more than one base.
    if len(ref) == 1 and len(alt) == 1:
        chr_ref = CHR_MAP[chr]
        pos_hgvs = f'g.{pos}'
    ...
    with open(output_path, 'w', newline='') as csvfile:
        ...
        with open(input_file_path, 'rt') as input_file:
            ...
            for row in reader:
                ...
                spdi = build_spdi(chr, pos, ref, alt, allele, translator)
                hgvs = build_hgvs(chr, pos, ref, alt, allele, translator)
