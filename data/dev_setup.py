...
ADAPTERS = {
    ...
    'go_nodes_mf': Ontology(ontology='GO', type='node', subontology='molecular function'),
    'go_edges_mf': Ontology(ontology='GO', type='edge', subontology='molecular function'),
    'go_nodes_cc': Ontology(ontology='GO', type='node', subontology='cellular component'),
    'go_edges_cc': Ontology(ontology='GO', type='edge', subontology='cellular component'),
    'go_nodes_bp': Ontology(ontology='GO', type='node', subontology='biological process'),
    'go_edges_bp': Ontology(ontology='GO', type='edge', subontology='biological process'),
