...
ADAPTERS = {
    ...
    'encode_regulatory_region_gene': EncodeElementGeneLink('./samples/epiraction_ENCFF712SUP.bed.gz', 'element_gene', 'ENCODE_EpiRaction', 'https://www.encodeproject.org/files/ENCFF712SUP/', 'CL_0000765'),
    'encode_regulatory_region_gene_biosample': EncodeElementGeneLink('./samples/epiraction_ENCFF712SUP.bed.gz', 'regulatory_region_gene_biosample', 'ENCODE_EpiRaction', 'https://www.encodeproject.org/files/ENCFF712SUP/', 'CL_0000765'),
    'encode_regulatory_region_gene_treatment_CHEBI': EncodeElementGeneLink('./samples/E2G_ENCFF617FJH.bed.gz', 'encode_regulatory_region_gene_treatment_CHEBI', 'ENCODE-E2G-DNaseOnly', 'https://www.encodeproject.org/files/ENCFF617FJH/', 'EFO_0001203'),
    'encode_regulatory_region_gene_treatment_protein': EncodeElementGeneLink('./samples/E2G_ENCFF617FJH.bed.gz', 'encode_regulatory_region_gene_treatment_protein', 'ENCODE-E2G-DNaseOnly', 'https://www.encodeproject.org/files/ENCFF617FJH/', 'EFO_0001203'),
