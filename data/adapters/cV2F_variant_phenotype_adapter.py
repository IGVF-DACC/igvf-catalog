    ...
    def process_variants_phenotypes_chunk(self, chunk):
        ...
        for row in chunk:
            ...
            props = {
                ...
                'files_filesets': 'files_filesets/' + self.file_accession,
                'biological_context': self.files_filesets.get('simple_sample_summaries')[0] if self.files_filesets.get('simple_sample_summaries') else None,
                'biosample_term': self.files_filesets.get('samples')[0] if self.files_filesets.get('samples') else None,
                'method': self.files_filesets.get('method'),
                'class': self.files_filesets.get('class'),
