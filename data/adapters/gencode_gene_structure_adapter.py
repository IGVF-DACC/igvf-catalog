            ...
            if type in GencodeStructure.STRUCTURE_TYPES:
                ...
                if type == 'exon':
                    if info['transcript_id'] == exon_transcript:
                        intron_start = last_exon_end if info[
                            'strand'] == '+' else split_line[GencodeStructure.INDEX['coord_end']]
                        intron_end = int(
                            split_line[GencodeStructure.INDEX['coord_start']]) - 1 if info['strand'] == '+' else last_exon_end - 1
                    ...
                    last_exon_end = int(
                        split_line[GencodeStructure.INDEX['coord_end']]) if info['strand'] == '+' else int(
