...
class CRISPR_E2P(BaseAdapter):
    ...
    FILE_CONFIG = {
        'IGVFFI5135QZCS': {
            ...
            'hit_guide_count_col': 'hit_gRNA_count_mig',
            'nonhit_guide_count_col': 'nonhit_gRNA_count_mig',
            'fraction_hit_col': 'fraction_hit_mig',
        ...
        'IGVFFI9584UDAS': {
            ...
            'hit_guide_count_col': 'hit_gRNA_count_growth',
            'nonhit_guide_count_col': 'nonhit_gRNA_count_growth',
            'fraction_hit_col': 'fraction_hit_growth',
    ...
    def _write_genomic_element_phenotypes(self, reader):
        ...
        for row in reader:
            ...
            props = {
                ...
                'hit_guide_count': int(row[config['hit_guide_count_col']]),
                'nonhit_guide_count': int(row[config['nonhit_guide_count_col']]),
                'fraction_hit': float(row[config['fraction_hit_col']]),
                'method': self.method,
