...
| ccre regulatory region                            | node | candidate_cis_regulatory_elements   | N | {ENCODE_candidate_cis_regulatory_element_id} | EH38E2776516 |
| gene                                              | node | genes                               | N | {Ensembl ID} | ENSG00000290825 |
| ontology term                                     | node | ontology_terms                      | N | {prefix}:{ontology}_{id} | efo:EFO_0001086 |
| protein                                           | node | proteins                            | N | {Uniprot ID} | P31946 |
| regulatory region                                 | node | regulatory_regions                  | N | {class_name}\_{chr}\_{start}\_{end}\_{assembly} | enhancer_chr1_827140_827667_GRCh38 |
| transcript                                        | node | transcripts                         | N |  {Ensembl ID} | ENST00000456328 |
| sequence variant                                  | node | variants                            | Y | {chr}_{start}\_{ref_seq}\_{alt_seq}\_{assembly} | 20_9567040_T_G_GRCh38 |
| asb                                               | edge | variant_protein_links               | N | {variant_id}{tf_uniprot_id}{cell_ontology_id} |
...
| regulatory element to gene expression association | edge | element_gene_links                  | N | {regulatory region id}_{gene id} | enhancer_chr1_827140_827667_GRCh38_ENSG00000187634 |
| topld in linkage disequilibrium with              | edge | variant_correlations                | Y | {ancestry}{chr}{Uniq_ID_1}{Uniq_ID_1}{assembly}|
