    ...
    '/complexes/search': [{
        ...
        'response': [
            ...
            },
            {
                ...
                'evidence_code': 'ECO:0000353(physical interaction evidence used in manual assertion)',
                'experimental_evidence': 'intact:EBI-6878536',
                'description': "Transcription factor complex which binds DNA through the E2 recognition site, 5'-TTTC[CG]CGC-3', typically associated with the promoters of genes active in S phase. Activates genes that stimulate DNA synthesis and cell cycle advancement.",
                'complex_assembly': 'Heterodimer',
                'complex_source': "psi-mi:\"MI:0469\"(IntAct)",
                'reactome_xref': [],
                'source': 'EBI',
            ...
            },
            {
                ...
                'experimental_evidence': None,
                'description': "Transcription factor complex which binds DNA through the E2 recognition site, 5'-TTTC[CG]CGC-3', typically associated with active promoters in S phase, activating genes that stimulate DNA synthesis and cell cycle advancement.",
                'complex_assembly': 'Heterodimer',
                'complex_source': "psi-mi:\"MI:0469\"(IntAct)",
                'reactome_xref': [
                    'R-HSA-9007512(see-also)'
                ],
                'source': 'EBI',
                'source_url': 'https://www.ebi.ac.uk/complexportal/'
            },
