            ...
            },
            {
                'sequence variant': {
                    ...
                    'annotations': {
                        ...
                        'varinfo': '11-30355151-A-T',
                        'vid': '1.18212e+09',
                        'variant_vcf': '11-30355151-A-T',
                        'variant_annovar': '11-30355151-30355151-A-T',
                        'start_position': '3.03552e+07',
                        'end_position': '3.03552e+07',
                        'ref_annovar': 'A',
                        'alt_annovar': 'T',
                        'ref_vcf': 'A',
                        'alt_vcf': 'T',
                        'apc_conservation': 1.13948,
                        'apc_conservation_v2': 1.5956,
                        'apc_epigenetics_active': 1.2633,
                        'apc_epigenetics': 1.26906,
                        'apc_epigenetics_repressed': 4.04516,
                        'apc_epigenetics_transcription': 0.920432,
                        'apc_local_nucleotide_diversity': 6.31717,
                        'apc_local_nucleotide_diversity_v2': 1.52751,
                        'apc_local_nucleotide_diversity_v3': 2.0645,
                        'apc_mappability': 1.96703,
                        'apc_micro_rna': 99.4512,
                        'apc_mutation_density': 1.43024,
                        'apc_protein_function': 20.2494,
                        'apc_protein_function_v2': 4.92793e-10,
                        'apc_protein_function_v3': 2.96949,
                        'apc_proximity_to_coding': 6.38527,
                        'apc_proximity_to_coding_v2': 15.1786,
                        'apc_proximity_to_tsstes': 4.6833,
                        'apc_transcription_factor': 4.69789,
                        'bravo_an': '264690',
                        'bravo_af': '0.177287',
                        'filter_status': 'PASS',
                        ...
                        'funseq_description': 'noncoding',
                        'af_total': 0.183031,
                        'af_asj_female': 0.186932,
                        'af_eas_female': 0.231302,
                        'af_afr_male': 0.0969863,
                        'af_female': 0.184798,
                        'af_fin_male': 0.19223,
                        'af_oth_female': 0.192168,
                        'af_ami': 0.351111,
                        'af_oth': 0.204651,
                        'af_male': 0.181151,
                        'af_ami_female': 0.359574,
                        'af_afr': 0.097838,
                        'af_eas_male': 0.241071,
                        'af_sas': 0.127548,
                        'af_nfe_female': 0.237545,
                        'af_asj_male': 0.169654,
                        'af_raw': 0.183208,
                        'af_oth_male': 0.217681,
                        'af_nfe_male': 0.242008,
                        'af_asj': 0.178808,
                        'af_amr_male': 0.159591,
                        'af_amr_female': 0.149084,
                        'af_fin': 0.196298,
                        'af_afr_female': 0.098563,
                        'af_sas_male': 0.125202,
                        'af_amr': 0.155043,
                        'af_nfe': 0.239423,
                        'af_eas': 0.236556,
                        'af_ami_male': 0.34186,
                        'af_fin_female': 0.2092,
                        'cadd_rawscore': '0.016753',
                        'cadd_phred': '1.906',
                        'tg_afr': '0.0673',
                        'tg_all': '0.154752',
                        'tg_amr': '0.1282',
            ...
            },
            {
                'sequence variant': {
                    ...
                    'annotations': {
                        ...
                        'varinfo': '19-33578400-C-A',
                        'vid': '3.54851e+09',
                        'variant_vcf': '19-33578400-C-A',
                        'variant_annovar': '19-33578400-33578400-C-A',
                        'start_position': '3.35784e+07',
                        'end_position': '3.35784e+07',
                        'ref_annovar': 'C',
                        'alt_annovar': 'A',
                        'ref_vcf': 'C',
                        'alt_vcf': 'A',
                        'apc_conservation': 0.118639,
                        'apc_conservation_v2': 0.130936,
                        'apc_epigenetics_active': 3.58352,
                        'apc_epigenetics': 4.541,
                        'apc_epigenetics_repressed': 6.66542,
                        'apc_epigenetics_transcription': 3.61159,
                        'apc_local_nucleotide_diversity': 6.26816,
                        'apc_local_nucleotide_diversity_v2': 0.123806,
                        'apc_local_nucleotide_diversity_v3': 0.0929243,
                        'apc_mappability': 6.15012,
                        'apc_micro_rna': 99.4512,
                        'apc_mutation_density': 0.116122,
                        'apc_protein_function': 20.2494,
                        'apc_protein_function_v2': 4.92793e-10,
                        'apc_protein_function_v3': 2.96949,
                        'apc_proximity_to_coding': 4.22027,
                        'apc_proximity_to_coding_v2': 15.1786,
                        'apc_proximity_to_tsstes': 5.16942,
                        'apc_transcription_factor': 5.7871,
                        'bravo_an': '264690',
                        'bravo_af': '0.1693',
                        'filter_status': 'PASS',
                        ...
                        'funseq_description': 'noncoding',
                        'af_total': 0.177469,
                        'af_asj_female': 0.272985,
                        'af_eas_female': 0.0843707,
                        'af_afr_male': 0.13651,
                        'af_female': 0.178167,
                        'af_fin_male': 0.203101,
                        'af_oth_female': 0.190826,
                        'af_ami': 0.193333,
                        'af_oth': 0.192164,
                        'af_male': 0.176725,
                        'af_ami_female': 0.2,
                        'af_afr': 0.135948,
                        'af_eas_male': 0.0956057,
                        'af_sas': 0.167436,
                        'af_nfe_female': 0.206024,
                        'af_asj_male': 0.259615,
                        'af_raw': 0.177635,
                        'af_oth_male': 0.193548,
                        'af_nfe_male': 0.205716,
                        'af_asj': 0.266707,
                        'af_amr_male': 0.151061,
                        'af_amr_female': 0.148274,
                        'af_fin': 0.200996,
                        'af_afr_female': 0.135468,
                        'af_sas_male': 0.162217,
                        'af_amr': 0.149853,
                        'af_nfe': 0.205894,
                        'af_eas': 0.0904153,
                        'af_ami_male': 0.186047,
                        'af_fin_female': 0.194334,
                        'cadd_rawscore': '-0.526089',
                        'cadd_phred': '0.043',
                        'tg_afr': '0.1611',
                        'tg_all': '0.152356',
                        'tg_amr': '0.1398',
            ...
            },
            {
                'sequence variant': {
                    ...
                    'annotations': {
                        ...
                        'varinfo': '2-171524205-CGGCATCAG-C',
                        'vid': '8.85175e+09',
                        'variant_vcf': '2-171524205-CGGCATCAG-C',
                        'variant_annovar': '2-171524206-171524213-GGCATCAG--',
                        'start_position': '1.71524e+08',
                        'end_position': '1.71524e+08',
                        'ref_annovar': 'GGCATCAG',
                        'alt_annovar': '-',
                        'ref_vcf': 'CGGCATCAG',
                        'alt_vcf': 'C',
                        'af_total': 0.373228,
                        'af_asj_female': 0.441477,
                        'af_eas_female': 0.202909,
                        'af_afr_male': 0.401703,
                        'af_female': 0.374145,
                        'af_fin_male': 0.25562,
                        'af_oth_female': 0.364717,
                        'af_ami': 0.34375,
                        'af_oth': 0.375116,
                        'af_male': 0.372252,
                        'af_ami_female': 0.333333,
                        'af_afr': 0.396246,
                        'af_eas_male': 0.204545,
                        'af_sas': 0.41453,
                        'af_nfe_female': 0.367539,
                        'af_asj_male': 0.419231,
                        'af_raw': 0.373357,
                        'af_oth_male': 0.385932,
                        'af_nfe_male': 0.37372,
                        'af_asj': 0.431024,
                        'af_amr_male': 0.428109,
                        'af_amr_female': 0.40889,
                        'af_fin': 0.26137,
                        'af_afr_female': 0.3916,
                        'af_sas_male': 0.406704,
                        'af_amr': 0.419788,
                        'af_nfe': 0.37014,
                        'af_eas': 0.203787,
                        'af_ami_male': 0.35514,
