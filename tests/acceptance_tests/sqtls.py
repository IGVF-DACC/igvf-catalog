            ...
            },
            {
                'sequence variant': {
                    ...
                    'annotations': {
                        ...
                        'varinfo': '6-31917046-T-C',
                        'vid': '6.57774e+09',
                        'variant_vcf': '6-31917046-T-C',
                        'variant_annovar': '6-31917046-31917046-T-C',
                        'start_position': '3.1917e+07',
                        'end_position': '3.1917e+07',
                        'ref_annovar': 'T',
                        'alt_annovar': 'C',
                        'ref_vcf': 'T',
                        'alt_vcf': 'C',
                        'apc_conservation': 3.25682,
                        'apc_conservation_v2': 2.83175,
                        'apc_epigenetics_active': 0.78302,
                        'apc_epigenetics': 0.781658,
                        'apc_epigenetics_repressed': 0.535681,
                        'apc_epigenetics_transcription': 0.583096,
                        'apc_local_nucleotide_diversity': 1.67551,
                        'apc_local_nucleotide_diversity_v2': 11.3669,
                        'apc_local_nucleotide_diversity_v3': 10.4256,
                        'apc_mappability': 1.31538,
                        'apc_micro_rna': 99.4512,
                        'apc_mutation_density': 11.6292,
                        'apc_protein_function': 20.2494,
                        'apc_protein_function_v2': 4.92793e-10,
                        'apc_protein_function_v3': 2.96949,
                        'apc_proximity_to_coding': 2.31562,
                        'apc_proximity_to_coding_v2': 15.1786,
                        'apc_proximity_to_tsstes': 4.08338,
                        'apc_transcription_factor': 3.14279,
                        'bravo_an': '264690',
                        'bravo_af': '0.919328',
                        'filter_status': 'PASS',
                        ...
                        'funseq_description': 'noncoding',
                        'af_total': 0.910191,
                        'af_asj_female': 0.96875,
                        'af_eas_female': 0.993759,
                        'af_afr_male': 0.971877,
                        'af_female': 0.909875,
                        'af_fin_male': 0.870442,
                        'af_oth_female': 0.937615,
                        'af_ami': 0.930958,
                        'af_oth': 0.933458,
                        'af_male': 0.910528,
                        'af_ami_female': 0.933761,
                        'af_afr': 0.971913,
                        'af_eas_male': 0.9875,
                        'af_sas': 0.96992,
                        'af_nfe_female': 0.861606,
                        'af_asj_male': 0.969191,
                        'af_raw': 0.91016,
                        'af_oth_male': 0.929119,
                        'af_nfe_male': 0.859812,
                        'af_asj': 0.968957,
                        'af_amr_male': 0.925732,
                        'af_amr_female': 0.940562,
                        'af_fin': 0.872139,
                        'af_afr_female': 0.971943,
                        'af_sas_male': 0.969262,
                        'af_amr': 0.932152,
                        'af_nfe': 0.860852,
                        'af_eas': 0.990391,
                        'af_ami_male': 0.927907,
                        'af_fin_female': 0.877602,
                        'cadd_rawscore': '0.209721',
                        'cadd_phred': '4.188',
                        'tg_afr': '0.9932',
                        'tg_all': '0.963458',
                        'tg_amr': '0.9654',
            ...
            },
            {
                'sequence variant': {
                    ...
                    'annotations': {
                        ...
                        'varinfo': '8-8688374-T-C',
                        'vid': '7.49505e+09',
                        'variant_vcf': '8-8688374-T-C',
                        'variant_annovar': '8-8688374-8688374-T-C',
                        'start_position': '8.68837e+06',
                        'end_position': '8.68837e+06',
                        'ref_annovar': 'T',
                        'alt_annovar': 'C',
                        'ref_vcf': 'T',
                        'alt_vcf': 'C',
                        'apc_conservation': 1.69872,
                        'apc_conservation_v2': 1.86728,
                        'apc_epigenetics_active': 1.51783,
                        'apc_epigenetics': 1.16301,
                        'apc_epigenetics_repressed': 2.03342,
                        'apc_epigenetics_transcription': 0.675675,
                        'apc_local_nucleotide_diversity': 2.5158,
                        'apc_local_nucleotide_diversity_v2': 0.0925699,
                        'apc_local_nucleotide_diversity_v3': 0.112424,
                        'apc_mappability': 4.77409,
                        'apc_micro_rna': 99.4512,
                        'apc_mutation_density': 0.0926368,
                        'apc_protein_function': 20.2494,
                        'apc_protein_function_v2': 4.92793e-10,
                        'apc_protein_function_v3': 2.96949,
                        'apc_proximity_to_coding': 4.81849,
                        'apc_proximity_to_coding_v2': 15.1786,
                        'apc_proximity_to_tsstes': 4.42457,
                        'apc_transcription_factor': 3.14279,
                        'bravo_an': '264690',
                        'bravo_af': '0.311183',
                        'filter_status': 'PASS',
                        ...
                        'funseq_description': 'noncoding',
                        'af_total': 0.322325,
                        'af_asj_female': 0.419886,
                        'af_eas_female': 0.0538674,
                        'af_afr_male': 0.294562,
                        'af_female': 0.329616,
                        'af_fin_male': 0.280784,
                        'af_oth_female': 0.322727,
                        'af_ami': 0.353333,
                        'af_oth': 0.311049,
                        'af_male': 0.314562,
                        'af_ami_female': 0.365957,
                        'af_afr': 0.295665,
                        'af_eas_male': 0.043943,
                        'af_sas': 0.240789,
                        'af_nfe_female': 0.374003,
                        'af_asj_male': 0.437821,
                        'af_raw': 0.322506,
                        'af_oth_male': 0.298861,
                        'af_nfe_male': 0.373978,
                        'af_asj': 0.428313,
                        'af_amr_male': 0.248254,
                        'af_amr_female': 0.244666,
                        'af_fin': 0.280722,
                        'af_afr_female': 0.296603,
                        'af_sas_male': 0.242522,
                        'af_amr': 0.2467,
                        'af_nfe': 0.373993,
                        'af_eas': 0.0485313,
                        'af_ami_male': 0.339535,
                        'af_fin_female': 0.280527,
                        'cadd_rawscore': '-0.075203',
                        'cadd_phred': '1.161',
                        'tg_afr': '0.2821',
                        'tg_all': '0.238818',
                        'tg_amr': '0.245',
            ...
            },
            {
                'sequence variant': {
                    ...
                    'annotations': {
                        ...
                        'varinfo': '6-170558169-T-A',
                        'vid': '6.99184e+09',
                        'variant_vcf': '6-170558169-T-A',
                        'variant_annovar': '6-170558169-170558169-T-A',
                        'start_position': '1.70558e+08',
                        'end_position': '1.70558e+08',
                        'ref_annovar': 'T',
                        'alt_annovar': 'A',
                        'ref_vcf': 'T',
                        'alt_vcf': 'A',
                        'apc_conservation': 3.72849,
                        'apc_conservation_v2': 4.25412,
                        'apc_epigenetics_active': 8.43435,
                        'apc_epigenetics': 9.53021,
                        'apc_epigenetics_repressed': 0.992058,
                        'apc_epigenetics_transcription': 19.2746,
                        'apc_local_nucleotide_diversity': 1.03259,
                        'apc_local_nucleotide_diversity_v2': 5.12883,
                        'apc_local_nucleotide_diversity_v3': 4.566,
                        'apc_mappability': 8.95186,
                        'apc_micro_rna': 99.4512,
                        'apc_mutation_density': 5.55791,
                        'apc_protein_function': 20.2494,
                        'apc_protein_function_v2': 4.92793e-10,
                        'apc_protein_function_v3': 2.96949,
                        'apc_proximity_to_coding': 1.03,
                        'apc_proximity_to_coding_v2': 15.1786,
                        'apc_proximity_to_tsstes': 10.0879,
                        'apc_transcription_factor': 4.69789,
                        'bravo_an': '264690',
                        'bravo_af': '0.380154',
                        'filter_status': 'PASS',
                        ...
                        'funseq_description': 'noncoding',
                        'af_total': 0.375416,
                        'af_asj_female': 0.322361,
                        'af_eas_female': 0.776006,
                        'af_afr_male': 0.287364,
                        'af_female': 0.371796,
                        'af_fin_male': 0.439092,
                        'af_oth_female': 0.388182,
                        'af_ami': 0.61,
                        'af_oth': 0.386722,
                        'af_male': 0.379269,
                        'af_ami_female': 0.580851,
                        'af_afr': 0.285976,
                        'af_eas_male': 0.790822,
                        'af_sas': 0.421916,
                        'af_nfe_female': 0.403628,
                        'af_asj_male': 0.31859,
                        'af_raw': 0.375412,
                        'af_oth_male': 0.385199,
                        'af_nfe_male': 0.40159,
                        'af_asj': 0.32059,
                        'af_amr_male': 0.361204,
                        'af_amr_female': 0.371066,
                        'af_fin': 0.438267,
                        'af_afr_female': 0.284794,
                        'af_sas_male': 0.427075,
                        'af_amr': 0.365475,
                        'af_nfe': 0.40277,
                        'af_eas': 0.783974,
                        'af_ami_male': 0.64186,
                        'af_fin_female': 0.435651,
                        'cadd_rawscore': '0.373525',
                        'cadd_phred': '6.108',
                        'tg_afr': '0.2731',
                        'tg_all': '0.451278',
                        'tg_amr': '0.4063',
