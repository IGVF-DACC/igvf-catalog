...
const variantsFromVariantID = publicProcedure
  .meta({ openapi: { method: 'GET', path: '/variants/variant-ld', description: descriptions.variants_variants, tags: ['Biological Context Data'] } })
...
const variantsFromVariantIDSummary = publicProcedure
  .meta({ openapi: { method: 'GET', path: '/variants/variant-ld/summary', description: descriptions.variants_variants_summary, tags: ['Bespoke Endpoints'] } })
