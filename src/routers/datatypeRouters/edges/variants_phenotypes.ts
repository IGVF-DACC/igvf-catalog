...
async function findVariantsFromPhenotypesSearch (input: paramsFormatType): Promise<any[]> {
  ...
  FOR record IN ${variantToPhenotypeCollectionName}
    ...
    RETURN {
      ...
      p_value: (record.source == 'OpenTargets' || record.method == 'CRISPR screen') ? record.p_value : null,
      neg_log10_pvalue: (record.source == 'OpenTargets' || record.method == 'CRISPR screen') ? record.neg_log10_pvalue : null,
      ...
      fdr:                record.method == 'CRISPR screen' ? record.fdr                : null,
      neg_log10_fdr:      record.method == 'CRISPR screen' ? record.neg_log10_fdr      : null,
      ...
      ci_lower:           record.method == 'CRISPR screen' ? record.ci_lower           : null,
      ci_upper:           record.method == 'CRISPR screen' ? record.ci_upper           : null,
