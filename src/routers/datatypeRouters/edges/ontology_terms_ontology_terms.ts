...
const ontologyTermChildren = publicProcedure
  .meta({ openapi: { method: 'GET', path: '/ontology-terms/{ontology_term_id}/children', description: descriptions.ontology_terms_children, tags: ['Bespoke Endpoints'] } })
...
const ontologyTermParents = publicProcedure
  .meta({ openapi: { method: 'GET', path: '/ontology-terms/{ontology_term_id}/parents', description: descriptions.ontology_terms_parents, tags: ['Bespoke Endpoints'] } })
  .input(ontologyRelativeQueryFormat)
  .output(z.array(ontologyRelativeFormat.optional()))
  .query(async ({ input }) => await getChildrenParents(input, 'parents'))

const ontologyTermTransitiveClosure = publicProcedure
  .meta({ openapi: { method: 'GET', path: '/ontology-terms/{ontology_term_id_start}/transitive-closure/{ontology_term_id_end}', description: descriptions.ontology_terms_transitive_closure, tags: ['Bespoke Endpoints'] } })
