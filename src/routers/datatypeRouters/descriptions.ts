export const descriptions = {
  ...
  proteins_variants: 'Retrieve allele-specific transcription factor binding events from ADASTRA in cell type-specific context, allele-specific transcription factor binding events from GVATdb, and pQTL from UKB by querying transcription factors.<br> \
