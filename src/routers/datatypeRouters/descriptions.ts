export const descriptions = {
  ...
  genes_proteins_go_terms: 'Retrieve GO annotations from either proteins or transcripts. Example: query = ATF1_HUMAN or query = ENST00000663609.',
  go_terms_genes_proteins: 'Retrieve annotations associated with a GO term. Example: go_term_id: GO_1990590.'
}
