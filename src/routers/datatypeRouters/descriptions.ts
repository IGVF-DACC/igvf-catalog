export const descriptions = {
    ...
    genes_id_transcripts: 'Retrieve transcripts from gene ids. Example: gene_id = ENSG00000230108',
    transcripts_genes: 'Retrieve genes from transcripts. Example: region = chr1:711800-740000',
    transcripts_id_genes: 'Retrieve genes from transcript ids. Example: transcript_id = ENST00000443707',
    genes_proteins: 'Retrieve proteins from genes. Example: gene_name = ATF3, gene_region = chr1:212565300-212620800, alias = CKLF',
    genes_id_proteins: 'Retrieve proteins from gene ids. Example: gene_id = ENSG00000230108',
    proteins_genes: 'Retrieve genes from proteins. Example: name = CTCF_HUMAN, dbxrefs = Orphanet:363611',
    proteins_id_genes: 'Retrieve genes from protein ids. Example: protein_id = P49711',
    ...
    transcripts_id_proteins: 'Retrieve proteins from transcript ids. Example: transcript_id = ENST00000401394',
    proteins_transcripts: 'Retrieve transcripts from proteins. Example: name = CTCF_HUMAN, dbxrefs = Orphanet:363611',
    proteins_id_transcripts: 'Retrieve transcripts from protein ids. Example: protein_id = P49711',
    ...
    variants_by_freq: 'Retrieve genetic variants by frequencies. Example: source = 1000genomes, funseq_description = coding (or noncoding), min_alt_freq: 0.1, max_alt_freq:0.8',
    ...
    r2 = gte:0.8, d_prime = gt:0.9, ancestry = EUR',
    ...
    // variants_asb: leave it until we fix the endpoint
    motifs: 'Retrieve transcription factor binding motifs from HOCOMOCO. Example: STAT3_HUMAN',
    ...
    diseases_genes: 'Retrieve disease-gene pairs from Orphanet by diseases. Example: term_name = fibrosis', // can replace with the full name term: 'cystic fibrosis' after fixing bug
    ...
    ontology_terms: 'Retrieve ontology terms. Example: term_id = Orphanet_101435, term_name = Rare genetic eye disease, source = EFO, subontology= molecular_function', // could probably drop subontology
    ...
    //need to replace the example term name after fixing the term repeats bug
