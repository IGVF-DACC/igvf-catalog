export const descriptions = {
  ...
  variants_summary: 'Retrieve genetic variants summary.<br> Example: variant_id = 14059ae1a1cd3cfddae8ba6932cc73300a93553250e8c8d17c48a39d5c847ea5 (internal hashed variant ids), spdi = NC_000010.11:379887:T:C, hgvs = NC_000010.11:g.379888T>C, rsid = rs188498370.',
  ...
  variants_variants: 'Retrieve genetic variants in linkage disequilibrium (LD).<br> The following parameters can be used to set thresholds on r2 and d_prime: gt (>), gte (>=), lt (<), lte (<=).<br> \
    Set verbose = true to retrieve full info on the variants.<br>  Example: variant_id = ec046cdcc26b8ee9e79f9db305b1e9d5a6bdaba2d2064176f9a4ea50007b1e9a, r2 = gte:0.8, d_prime = gt:0.9, ancestry = EUR. The limit parameter controls the page size and can not exceed 500.',
  variants_variants_summary: 'Retrieve a summary of genetic variants in linkage disequilibrium (LD).<br> \
    Example: variant_id = ec046cdcc26b8ee9e79f9db305b1e9d5a6bdaba2d2064176f9a4ea50007b1e9a, hgvs = NC_000011.10:g.9090011A>G, spdi = NC_000011.10:9090010:A:G, rsid = rs963167. The limit parameter controls the page size and can not exceed 500.',
  ...
  variants_genes_summary: 'Retrieve a summary of associated genes from GTEx eQTLs & splice QTLs by internal variant ids.<br> \
    Example: variant_id = c41b54297becfa593170b5a7e29199d17e06cda37bff9edea5e5b8b333f95a70, rsid = rs77568453, spdi = NC_000001.11:920568:G:A, hgvs = NC_000001.11:g.920569G>A.',
  ...
  phenotypes_variants: 'Retrieve variant-trait pairs from GWAS by phenotypes.<br> The following parameters can be used to set thresholds on -log10 p_value: gt (>), gte (>=), lt (<), lte (<=).<br> \
    Set verbose = true to retrieve full info on the variants.<br> Example: term_id (phenotype ID) = EFO_0007937, term_name = blood protein measurement, log10pvalue = gte:5<br>The limit parameter controls the page size and can not exceed 100.',
  ...
  variants_regulatory_regions: 'Retrieve enhancer gene predictions associated with a given variant. Example: variand_id = 002f7f9491550fa5e17fbfa2322a27a0f117b45fc8ff306863a689b26f1e2d23, hgvs = NC_000001.11:g.1629000del, spdi = NC_000001.11:1628997:GGG:GG, rsid = rs1317845941',
  variants_regulatory_regions_count: 'Retrieve counts of enhancer gene predictions and cell types associated with a given variant. Example: variand_id = 002f7f9491550fa5e17fbfa2322a27a0f117b45fc8ff306863a689b26f1e2d23, hgvs = NC_000001.11:g.1629000del, spdi = NC_000001.11:1628997:GGG:GG, rsid = rs1317845941',
