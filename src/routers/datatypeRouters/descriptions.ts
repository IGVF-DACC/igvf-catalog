export const descriptions = {
  ...
  Set verbose = true to retrieve full info on the proteins.<br> Example: complex_id: CPX-9, name: SMAD2, description: phosphorylation.<br>The limit parameter controls the page size and can not exceed 50.',
